...
namespace Christoc.Modules.EmailTokenModule
{
    ...
    /// 
    /// Because the control inherits from EmailTokenModuleSettingsBase you have access to any custom properties
    /// defined there, as well as properties from DNN such as PortalId, ModuleId, TabId, UserId and many more.
    /// </summary>
    /// -----------------------------------------------------------------------------
    public partial class Settings : EmailTokenModuleModuleSettingsBase
    {
