...
namespace Christoc.Modules.AdminCharacterManagerModule.Data
{
    ...
    public abstract class DataProvider
    {
        ...
        public static DataProvider Instance()
        {
            if (provider == null)
            {
                const string assembly = "Christoc.Modules.AdminCharacterManagerModule.Data.SqlDataprovider,AdminCharacterManagerModule";
