...
namespace Christoc.Modules.SkirmishModule
{
    ...
    /// 
    /// Because the control inherits from SkirmishModuleSettingsBase you have access to any custom properties
    /// defined there, as well as properties from DNN such as PortalId, ModuleId, TabId, UserId and many more.
    /// </summary>
    /// -----------------------------------------------------------------------------
    public partial class Settings : SkirmishModuleModuleSettingsBase
    {
