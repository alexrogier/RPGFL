...
namespace Christoc.Modules.StandingsModule
{
    ...
    /// 
    /// Because the control inherits from StandingsModuleSettingsBase you have access to any custom properties
    /// defined there, as well as properties from DNN such as PortalId, ModuleId, TabId, UserId and many more.
    /// </summary>
    /// -----------------------------------------------------------------------------
    public partial class Settings : StandingsModuleModuleSettingsBase
    {
