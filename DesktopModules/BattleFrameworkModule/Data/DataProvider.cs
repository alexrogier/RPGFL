...
namespace Christoc.Modules.BattleFrameworkModule.Data
{
    ...
    public abstract class DataProvider
    {
        ...
        public static DataProvider Instance()
        {
            if (provider == null)
            {
                const string assembly = "Christoc.Modules.BattleFrameworkModule.Data.SqlDataprovider,BattleFrameworkModule";
