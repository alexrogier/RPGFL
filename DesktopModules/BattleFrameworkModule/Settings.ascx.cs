...
namespace Christoc.Modules.BattleFrameworkModule
{
    ...
    /// 
    /// Because the control inherits from BattleFrameworkModuleSettingsBase you have access to any custom properties
    /// defined there, as well as properties from DNN such as PortalId, ModuleId, TabId, UserId and many more.
    /// </summary>
    /// -----------------------------------------------------------------------------
    public partial class Settings : BattleFrameworkModuleModuleSettingsBase
    {
